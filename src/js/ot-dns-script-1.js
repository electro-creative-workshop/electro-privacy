    ...
    if (dsIdSet == false) {
        let otEmailHTML = `
            ...
            <div id="ot-email-text" style="display: none">
                <h3 style="font-size: inherit;">Behavioral Advertising Linked To Your Email Address:</h3>
                <br />
                ...
                <hr />
                <h3 style="font-size: inherit;">Deletion, Access, Or Correction Requests</h3>
                <br />
                If you are a U.S. consumer and would like to exercise other privacy rights, 
        ...
        let dnsCustomText = `
            <div id="dns-custom-text" style="display: none">
                <h3 style="font-size: inherit;">Do Not Sell or Share for Targeted Advertising</h3>';
                <br />';
