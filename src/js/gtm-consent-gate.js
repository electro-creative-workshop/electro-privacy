...
GtmConsentGate.propTypes = {
  gtmId: PropTypes.string.isRequired,
  gaMeasurementIds: PropTypes.arrayOf(PropTypes.string),
  performanceCode: PropTypes.string,
  GoogleTagManager: PropTypes.elementType.isRequired,
};
