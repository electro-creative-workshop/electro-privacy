...
/******/ (() => {
    ...
    /******/ var __webpack_modules__ = {
        ...
        /***/ 721(__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) {
            // EXTERNAL MODULE: ./src/js/language-support.js
            var language_support = __webpack_require__(132); // ./src/js/validateEmail.js
            ...
            const NON_PRODUCTION_HOST_PATTERNS = ['lndo.site', 'pantheonsite', 'staging', 'dev', 'qa', 'local'];
            ...
            function setPreferences(otDataSubjectId) {
                ...
                xhr.onload = function () {
                    if (xhr.status >= 200 && xhr.status < 300) {
                        ...
                        showStatusMessage(
                            'success',
                            (0, language_support /* getLanguageString */.M)('Successfully Submitted!')
                        );
                    } else {
            ...
            function showStatusMessage(type, message) {
                ...
                div.setAttribute(
                    'style',
                    isSuccess ? 'color: green; font-weight: bold;' : 'color: red; font-weight: bold;'
                );
            ...
            function showErrorMessage() {
                showStatusMessage(
                    'error',
                    (0, language_support /* getLanguageString */.M)('An error occurred. Please try again.')
                );
            }
            ...
            function inputValidation() {
                ...
                if (isValidEmailIdentifier(emailValue)) {
                    ...
                    showStatusMessage(
                        'error',
                        (0, language_support /* getLanguageString */.M)('Please enter a valid email.')
                    );
                }
            }
            ...
            function dnsCheck() {
                try {
                    ...
                    if (
                        document.getElementById('do-not-share') &&
                        document.getElementById('ot-email') &&
                        document.getElementById('ot-dns-submit')
                    ) {
                        // add pattern to email input
                        document.getElementById('ot-email').pattern = re;
                        document
                            .getElementById('ot-email')
                            .setCustomValidity(
                                (0, language_support /* getLanguageString */.M)('Please enter a valid email.')
                            );
                        ...
                        document.addEventListener(
                            ...
                            function (e) {
                                ...
                                if ((e.target && e.target.id === 'ot-sdk-btn') || sdkButton?.contains(e.target)) {
                                    ...
                                    (e.target && e.target.id === 'do-not-share') ||
                                    dnsButton?.contains(e.target)
                                ) {
                                    doNotShareUI();
                                }
                            },
                        ...
                        document.querySelectorAll('#ot-group-id-C0004')[0].addEventListener('change', function () {
                            document.getElementById('ot-checkbox-status').textContent = this.checked
                                ? (0, language_support /* getLanguageString */.M)('On')
                                : (0, language_support /* getLanguageString */.M)('Off');
                        });
    ...
    if (typeof window !== 'undefined') {
        window.electroPrivacyVersion = true ? '1.7.2' : 0;
    }
    ...
    async function OptanonWrapperLocal() {
        ...
        if (!dsIdSet) {
            const emailTitle = (0, _language_support__WEBPACK_IMPORTED_MODULE_0__ /* .getLanguageString */.M)(
                'Behavioral Advertising Linked To Your Email Address:'
            );
            const emailBlock = (0, _language_support__WEBPACK_IMPORTED_MODULE_0__ /* .getLanguageString */.M)(
                'emailTextBlock'
            );
            ...
            const emailInstructions = (0, _language_support__WEBPACK_IMPORTED_MODULE_0__ /* .getLanguageString */.M)(
                'Once you have made all of your elections, click “Save Settings” to save your settings and close the window.'
            );
            const deletionRequests = (0, _language_support__WEBPACK_IMPORTED_MODULE_0__ /* .getLanguageString */.M)(
                'Deletion, Access, Or Correction Requests'
            );
            const deletionTextBlock1 = (0, _language_support__WEBPACK_IMPORTED_MODULE_0__ /* .getLanguageString */.M)(
                'deletionTextBlock1'
            );
            const deletionTextBlock2 = (0, _language_support__WEBPACK_IMPORTED_MODULE_0__ /* .getLanguageString */.M)(
                'deletionTextBlock2'
            );
        ...
        `;
            ...
            const targetedAdsTitle = (0, _language_support__WEBPACK_IMPORTED_MODULE_0__ /* .getLanguageString */.M)(
                'Do Not Sell or Share for Targeted Advertising'
            );
            const targetedAdsTextBlock = (0, _language_support__WEBPACK_IMPORTED_MODULE_0__ /* .getLanguageString */.M)(
        ...
        `;
            ...
            toggleTextContainer.setAttribute(
                'style',
                'position: relative; top: -5px; display: inline-block; margin-left: 5px;'
            );
