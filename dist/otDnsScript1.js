...
function doNotShareUI() {
    ...
    document.getElementById('ot-checkbox-status').style.display = 'position: relative; width: 30px; bottom: 20px; left: 85%;';
...
async function OptanonWrapperLocal() {
    ...
    if (dsIdSet == false) {
        ...
        toggleTextContainer.setAttribute('style', 'position: relative; width: 30px; bottom: 20px; left: 85%;');
